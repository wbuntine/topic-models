...
\end{description}
After printing initial details, this will print three
sets of details.
The first is a list of top topic words. 
Such as:
\begin{verbatim}
Topic 0 words=gandhi,auction,phillips,sotheby,sale,1945,becket,martin,onassis,papers,...
Topic 1 words=pope,pontiff,appendix,crucitti,tumour,gemelli,parkinson,krakow,trembling,...
Topic 2 words=versace,cunanan,beach,wallace,mastroianni,miami,designer,philippines,...
\end{verbatim}
The second set is diagnostics about the topics:
\begin{verbatim}
Topic 0 stats: p=3.16%, ws=86.3%, ds=71.4%
Topic 1 stats: p=6.73%, ws=81.7%, ds=76.2%
Topic 2 stats: p=3.59%, ws=85.2%, ds=72.9%
\end{verbatim}
This means the topic 0 is observed in 3.16\% of word occurrences,
word sparsity for the topic is 86.3\%
(86.3\% of the words have zero entries for this topic),
and document sparsity for the topic is 71.4\%
(71.4\% of the documents have zero entries for this topic).
The final set is general diagostics:
\begin{verbatim}
